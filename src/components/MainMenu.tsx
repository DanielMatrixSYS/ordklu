    ...
    <div className="flex bg-gradient-to-t from-pink-100 to-pink-50 flex-col items-center w-full h-full">
      <div className="flex flex-col mt-4">
        <div className="flex flex-col">
          <h1 className="text-4xl/10 text-center text-neutral-700">
            Er du klar for dagens
          </h1>

          <h1 className="text-6xl font-bold text-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">
            Ordklu?
          </h1>
        </div>
